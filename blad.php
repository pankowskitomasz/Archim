...
<body>
    ...
    <section class="container-fluid d-flex">
        <div class="row my-auto ml-0 w-100">
            <div class="col-10 col-md-8 p-3 mx-auto text-center">
                <h3 class="section-title font-f1 text-secondary">Błąd!</h3>
                <p class="lead">
                    Niestety podczas rejestracji wiadamości wystąpił błąd. Prosimy 
                    spróbować ponownie lub skontaktować się z nami telefonicznie.
                </p>                
            </div>
        </div>       
    </section>
